...
import type LayoutConfigTypes from "@/components/layout/config/types";
import layoutConfig from "~/components/layout/config/DefaultLayoutConfig";

export const LS_CONFIG_NAME_KEY = "config_addin";
